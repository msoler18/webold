...
<html lang="es">
	...
	<head>
		...
		<link href="<?php echo URL; ?>libs/slick/slick.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo URL; ?>libs/slick/slick-theme.css" rel="stylesheet" type="text/css" />
