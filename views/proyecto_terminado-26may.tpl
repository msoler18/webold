...
<link rel="stylesheet" href="<?php echo URL; ?>/libs/lightbox/lightbox.css">
  <div class="vol">
...
<div class="info">
  <div class="container cont_proyectos_terminados">
    ...
    <div class="slider_mini">
      ...
      if($params['galeria'] != '[""]') :
        foreach(json_decode($params['galeria']) as $img) :
          echo '<div class="item" style="background: url('.URL.'assets/upload/gallery/'.$params['id'].'/'.$img.')no-repeat center; background-size: cover;">
            <a href="'.URL.'assets/upload/gallery/'.$params['id'].'/'.$img.'" data-lightbox="example-set"></a>
          </div>';
        endforeach;
      endif;
      ?>
